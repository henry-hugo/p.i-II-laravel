    ...
    <div class="collapse navbar-collapse pt-3 pb-2 py-lg-0 w-100" id="navigation">
      <ul class="navbar-nav navbar-nav-hover ms-lg-12 ps-lg-5 w-100">
        <li class="nav-item dropdown dropdown-hover mx-2">
          ...
          <div class="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3 tamanhomenu" aria-labelledby="dropdownMenuPages">
  ...
  <a href="" class="categoriamenu border-radius-md">
    <span class="ps-3">teste</span>
        ...
        <li class="nav-item ms-lg-auto">
          <a class="nav-link nav-link-icon me-2" type="button"  data-bs-toggle="modal" data-bs-target="#staticBackdrop3" >
            ...
            <p class="d-inline text-sm z-index-1 font-weight-bold" data-bs-toggle="tooltip" data-bs-placement="bottom" title="fale a suas duvidas aqui">fale conosco</p>
          </a>
        </li>
...
<div class="modal fade"  id="staticBackdrop3" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="10" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <div class="row">
      <table>
        <div class="filtro">
          ...
          <tbody id="myTable"> <?php $__currentLoopData = $produtos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <td>
                  <div class="card" style="width: 15rem;">
                      <img src="assets/img/curved-images/teste1.webp" class="card-img-top" alt="...">
                      <div class="card-body">
                          <h5 class="card-title"><?php echo e(($produto->PRODUTO_NOME)); ?></h5>
                          <p class="card-text"><?php echo e(($produto->PRODUTO_DESC)); ?></p>
                          <p class="card-number" ><?php echo e(($produto->PRODUTO_PRECO)); ?></p>
      ...
      <div class="col-12">
        <div class="text-center">
          <p class="my-4 text-sm">
            All rights reserved. Copyright © <script>document.write(new Date().getFullYear())</script> Foxtrot <a href="" target="_blank">Brinks</a>.
          </p>
        </div>
      </div>
    </div>
...
<script type="text/javascript">
  ...
  if (document.getElementById('state3')) {
    ...
    <!-- <ul> <?php $__currentLoopData = $produtos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <li><?php echo e($produto->PRODUTO_NOME); ?> <?php echo e($produto->PRODUTO_PRECO); ?> </li>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </ul>
    
    <p><?php echo e(($produtos)); ?></p> -->
<?php /**PATH C:\Users\hugo.hofleite\Documents\GitHub\p.i-II-laravel\resources\views/produto/index.blade.php ENDPATH**/ ?>